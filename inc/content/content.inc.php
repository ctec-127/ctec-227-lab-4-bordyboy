<?php
                ...
                while ($filename = readdir($dir_handle)) {
                    if (!is_dir($filename) && $filename != '.DS_Store') {
                        ...
                        <div class=\"card mr-3 mt-3\" >
                            <img class=\"\" src=\"$dir/$filename\" alt=\"Card image cap\">
                            <div>                          
    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET"){
        if (isset($_GET['file'])){
            unlink('uplodas/' . $_SESSION['username'] . "/" . $_GET['file']);
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="text-center">
                                <h1 class="control-label text-white">Image Gallery - <?= $_SESSION['username']; ?></h1>
                            </div>
